...
**Last updated:** 2026-06-04 (mobile filter sheet)
...
- **Mobile:** **Filters** header button or search modal “Open filters” → `FilterSheetModal` (tall bottom sheet, single-column sections, compact wrap chips, 2×2 footer toggles above Steam tags, one vertical scroll — no horizontal or nested tag scroll); **Clear filters** in bar header and sheet header (next to count); in-page expand panel not used
