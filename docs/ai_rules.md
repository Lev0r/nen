...
- **Progress tracking:** Check off items in [`docs/FEATURE_CHECKLIST.md`](./FEATURE_CHECKLIST.md) when completing features. Record new decisions in [`docs/DECISIONS.md`](./DECISIONS.md).
